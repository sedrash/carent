...
(function(){
  function initTranslateWidget(){
    ...
    const dictionary = {
      ...
      "Stages et jobs étudiants": { en: "Internships and student jobs", de: "Praktika und Studentenjobs", ar: "التدريبات والوظائف الطلابية" },
      "KU Leuven • Belgique • Été 2025": { en: "KU Leuven • Belgium • Summer 2025", de: "KU Leuven • Belgien • Sommer 2025", ar: "جامعة KU Leuven • بلجيكا • صيف 2025" },
      "Stage de recherche en Machine Learning distribué": { en: "Research internship in distributed Machine Learning", de: "Forschungspraktikum in verteiltem Machine Learning", ar: "تدريب بحثي في التعلم الآلي الموزع" },
      "Travail sur le déploiement de modèles de Machine Learning sur microcontrôleurs STM32/ESP32, avec une attention particulière portée à l’optimisation mémoire, à la latence et aux contraintes matérielles.": { en: "Work on deploying Machine Learning models on STM32/ESP32 microcontrollers, with particular attention to memory optimization, latency and hardware constraints.", de: "Arbeit an der Bereitstellung von Machine-Learning-Modellen auf STM32/ESP32-Mikrocontrollern, mit besonderem Fokus auf Speicheroptimierung, Latenz und Hardwarebeschränkungen.", ar: "العمل على نشر نماذج التعلم الآلي على متحكمات STM32/ESP32، مع اهتمام خاص بتحسين الذاكرة وزمن الاستجابة والقيود المادية." },
      "Optimisation": { en: "Optimization", de: "Optimierung", ar: "التحسين" },
      "Recherche": { en: "Research", de: "Forschung", ar: "البحث" },
      "adapter des modèles à des environnements limités en ressources et comprendre les compromis entre performance, mémoire et déploiement.": { en: "adapt models to resource-limited environments and understand trade-offs between performance, memory and deployment.", de: "Modelle an ressourcenbeschränkte Umgebungen anpassen und Kompromisse zwischen Leistung, Speicher und Bereitstellung verstehen.", ar: "تكييف النماذج مع بيئات محدودة الموارد وفهم التوازن بين الأداء والذاكرة والنشر." },
      "Optimisation de modèles, compression, quantification, déploiement d’algorithmes et analyse des performances.": { en: "Model optimization, compression, quantization, algorithm deployment and performance analysis.", de: "Modelloptimierung, Kompression, Quantisierung, Bereitstellung von Algorithmen und Leistungsanalyse.", ar: "تحسين النماذج، الضغط، التكميم، نشر الخوارزميات وتحليل الأداء." },
      "Programmation embarquée, rigueur scientifique, autonomie, communication en anglais et documentation technique.": { en: "Embedded programming, scientific rigor, autonomy, English communication and technical documentation.", de: "Embedded-Programmierung, wissenschaftliche Sorgfalt, Selbstständigkeit, Kommunikation auf Englisch und technische Dokumentation.", ar: "البرمجة المدمجة، الدقة العلمية، الاستقلالية، التواصل بالإنجليزية والتوثيق التقني." },
      "Crédit Agricole • Angers • Juillet - Août 2024": { en: "Crédit Agricole • Angers • July - August 2024", de: "Crédit Agricole • Angers • Juli - August 2024", ar: "Crédit Agricole • أنجيه • يوليو - أغسطس 2024" },
      "Helpline et support informatique": { en: "Helpline and IT support", de: "Helpline und IT-Support", ar: "الدعم الهاتفي والدعم المعلوماتي" },
      "Assistance informatique aux employés, avec prise en charge d’incidents, support à distance et suivi des demandes dans un contexte où la réactivité et la qualité de communication sont essentielles.": { en: "IT assistance for employees, handling incidents, remote support and request follow-up in a context where responsiveness and communication quality are essential.", de: "IT-Unterstützung für Mitarbeitende mit Bearbeitung von Vorfällen, Fernsupport und Nachverfolgung von Anfragen in einem Umfeld, in dem Reaktionsfähigkeit und Kommunikationsqualität wesentlich sind.", ar: "مساعدة تقنية للموظفين مع معالجة الحوادث والدعم عن بعد ومتابعة الطلبات في سياق تكون فيه سرعة الاستجابة وجودة التواصل أساسيتين." },
      "Support utilisateur": { en: "User support", de: "Benutzersupport", ar: "دعم المستخدمين" },
      "Ticketing IT": { en: "IT ticketing", de: "IT-Ticketing", ar: "تذاكر الدعم التقني" },
      "Diagnostic": { en: "Diagnosis", de: "Diagnose", ar: "التشخيص" },
      "Service client": { en: "Customer service", de: "Kundenservice", ar: "خدمة العملاء" },
      "aider les utilisateurs à retrouver rapidement un environnement de travail fonctionnel, tout en assurant un suivi clair des incidents.": { en: "help users quickly recover a functional work environment while ensuring clear incident follow-up.", de: "Benutzern helfen, schnell wieder eine funktionierende Arbeitsumgebung zu erhalten, und gleichzeitig eine klare Nachverfolgung der Vorfälle sicherstellen.", ar: "مساعدة المستخدمين على استعادة بيئة عمل فعالة بسرعة مع ضمان متابعة واضحة للحوادث." },
      "Support Windows et logiciels internes, résolution d’incidents, gestion de tickets et amélioration des procédures.": { en: "Windows and internal software support, incident resolution, ticket management and procedure improvement.", de: "Support für Windows und interne Software, Vorfalllösung, Ticketverwaltung und Verbesserung von Verfahren.", ar: "دعم Windows والبرامج الداخلية، حل الحوادث، إدارة التذاكر وتحسين الإجراءات." },
      "Dépannage système/réseau, écoute active, gestion du stress, communication claire et sens du service.": { en: "System/network troubleshooting, active listening, stress management, clear communication and service mindset.", de: "System-/Netzwerk-Fehlerbehebung, aktives Zuhören, Stressmanagement, klare Kommunikation und Serviceorientierung.", ar: "استكشاف أعطال النظام والشبكة، الاستماع الفعال، إدارة الضغط، التواصل الواضح وروح الخدمة." },
